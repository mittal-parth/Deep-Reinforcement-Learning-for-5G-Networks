...
from CustomLearningAgent import CustomLearningAgent as CustomLearner
...
def run_agent_custom(env, plotting=True):
    max_episodes_to_run = MAX_EPISODES_DEEP # needed to ensure epsilon decays to min
    max_timesteps_per_episode = radio_frame
    successful = False
    episode_successful = [] # a list to save the good episodes
...
for seed in seeds:
    ...
    agent = CustomLearner(seed = seed)
    run_agent_custom(env)
